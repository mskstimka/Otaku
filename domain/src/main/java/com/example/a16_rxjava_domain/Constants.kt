package com.example.a16_rxjava_domain
...
const val ROMANTIC_NAME = "Романтика"
const val SHOUNEN_ID = 27
const val SHOUNEN_NAME = "Сёнен"
const val DRAMA_ID = 8
const val DRAMA_NAME = "Драма"
const val DEMONS_ID = 6
const val DEMONS_NAME = "Демоны"
const val SHOUJO_ID = 25
const val SHOUJO_NAME = "Сёдзе"
const val HAREM_ID = 35
const val HAREM_NAME = "Гарем"
